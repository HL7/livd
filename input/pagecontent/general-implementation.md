...
When displaying the information to those configuring the mappings between IVD Test Codes and the appropriate LOINC codes, one must consider the relevant data to assist in the mapping.  We provide the following guidance for consideration:
