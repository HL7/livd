...
<ul>
   <li> General </li>
     <ul>
       <li> Whenever LOINC codes and other contents are displayed, the license agreement requires the proper notice to be displayed according to the [LOINC License](https://loinc.org/license/).  One may want to link to the proper web page, or make otherwise easily accessible.</li>
